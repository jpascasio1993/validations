...
class FieldMatchValidator<ValueType>
  ...
  FieldMatchValidator({
    this.baseField,
    this.matchField,
  }) : super([baseField, matchField]..removeWhere((element) => element == null));
  @override
  bool isValid(PropertyMap<ValueType> value, ValueContext context) {
    final baseValue = baseField == null ? null : value[baseField!];
    final matchValue = matchField == null ? null : value[matchField!];
